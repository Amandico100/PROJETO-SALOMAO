  ...
  " hover-elevate active-elevate-2",
  {
    variants: {
      variant: {
        ...
        shiny:
          "relative overflow-hidden bg-gradient-to-r from-emerald-500 to-cyan-500 text-white border border-white/20 before:content-[''] before:absolute before:inset-0 before:bg-gradient-to-r before:from-transparent before:via-white/40 before:to-transparent before:-translate-x-full before:animate-shimmer-fast",
      },
